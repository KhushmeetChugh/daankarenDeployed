...
const MyDonations = ({ user }) => {
  ...
  const fetchDonatedCampaigns = (userId) => {
    fetch(`https://daankarendeployed-1.onrender.com/fetchDonatedCampaigns/${userId}`)
...
const MyCampaigns = ({ user }) => {
  ...
  const fetchCampaigns = (userId) => {
    fetch(`https://daankarendeployed-1.onrender.com/fetchCampaignsOfUser/${userId}`)
      .then((response) => response.json())
...
const UpcomingRides = ({ user, volunteeredRides, setVolunteeredRides }) => {
  ...
  const handlePicked = async (rideId) => {
    try {
      const response = await fetch(
        `https://daankarendeployed-1.onrender.com/handlePick/${rideId}`,
        {
          method: "PUT",
        }
      );
  ...
  const handleDelivery = async (event, rideId) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://daankarendeployed-1.onrender.com/handleDelivery/${rideId}`,
        {
          method: "POST",
          body: formData,
        }
  ...
  const fetchVolunteeredRides = (userId) => {
    fetch(`https://daankarendeployed-1.onrender.com/volunteeredRides/${userId}`)
      .then((response) => response.json())
...
const DoneRides = ({ user, volunteeredRides }) => {
  ...
  const fetchCompletedRides = (userId) => {
    fetch(`https://daankarendeployed-1.onrender.com/completedRides/${userId}`)
      .then((response) => response.json())
...
const InitiatedRides = ({ user }) => {
  ...
  const fetchInitiatedRides = (userId) => {
    fetch(`https://daankarendeployed-1.onrender.com/initiatedRides/${userId}`)
      .then((response) => response.json())
  ...
  const handleSeen = async (rideId) => {
    try {
      const res = await fetch(`https://daankarendeployed-1.onrender.com/handleSeen/${rideId}`, {
        method: "PUT",
      });
...
const UserProfile = ({ user, volunteeredRides, completedRides }) => {
  ...
  const handleProfile = async (event) => {
    ...
    try {
      const response = await fetch(
        `https://daankarendeployed-1.onrender.com/handleProfile/${user._id}`,
        {
          method: "POST",
          body: formData,
        }
...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      try {
        ...
        const response = await fetch("https://daankarendeployed-1.onrender.com/fetchUserDetails", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchVolunteeredRides = async () => {
      try {
        const response = await fetch(
          `https://daankarendeployed-1.onrender.com/volunteeredRides/${user._id}`
        );
        const data = await response.json();
    ...
    const fetchCompletedRides = async () => {
      try {
        const response = await fetch(
          `https://daankarendeployed-1.onrender.com/completedRides/${user._id}`
        );
        const data = await response.json();
